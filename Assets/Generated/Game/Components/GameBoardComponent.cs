...
public partial class GameContext {
    ...
    public GameEntity SetBoard(UnityEngine.Vector2Int newBoardSize) {
        if (hasBoard) {
        ...
        entity.AddBoard(newBoardSize);
        return entity;
    }

    public void ReplaceBoard(UnityEngine.Vector2Int newBoardSize) {
        var entity = boardEntity;
        if (entity == null) {
            entity = SetBoard(newBoardSize);
        } else {
            entity.ReplaceBoard(newBoardSize);
        }
    }
